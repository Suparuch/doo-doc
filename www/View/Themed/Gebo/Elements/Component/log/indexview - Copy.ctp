		...
		<div class="box box-bordered box-color">
			...
			<div class="btn-group sepH_b">
					...
					<ul class="dropdown-menu">
                                                <li><a href="#myModal2" onclick="addUnit();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่ม </a></li>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center;">
							<a data-toggle="modal" data-backdrop="static" href="#myModal2" onclick="editUnit('<?php echo $rank['Unit']['id']; ?>');" ><i class="icon-pencil"></i></a>
							<a href="#"><i onclick="deleteUnit('<?php echo $rank['Unit']['id']; ?>')" class="icon-trash"></i></a>
							</td>
						</tr>
                                            <?php } ?>
                                            <?php }else {  ?>
