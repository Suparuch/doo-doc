				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tabOrganization_<?php echo $organization_type;?>">						
						<p>
							...
							<a href="#" id="edit_" data-role="button" class="btn btn-primary" onclick="editData('<?php echo $organization_type;?>','<?php echo $Organizations['OrganizationNew']['id'];?>');">แก้ไขหน่วย</a>
							<?php
								echo $this->element('Component/organization/detailviewOrganization2');
							?>
							</div>
						</p>
					</div>
					<div class="tab-pane" id="tabModel_<?php echo $organization_type;?>">
						<p>
							<?php
							echo $this->element('Component/organization/detailviewModel2');
							?>
						</p>
					</div>
				</div>
