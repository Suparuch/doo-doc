						...
						<div class="span12">
							<div class="box box-color box-bordered">
								<div class="box-title">
									...
									<?php echo __('ค้นหา') . ' ' . __('ข้อมูลชนิดหน่วย') ;?>
									</h3>
								</div>
                                                                
								<div class="box-content nopadding">
									<form  action="../../OrganizationTypes" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
												...
												<div class="controls">
													<div class="input-xlarge">
														<input name="name" type="text" value="<?php echo $default['name']; ?>" 
                                                                                        ...
                                                                                        <div class="span1">
                                                                                        <button id="<?php echo $pagination['model']; ?>-submit" type="submit" class="btn btn-primary hideme mm_16_list"><?php echo __('ค้นหา');?></button>
                                                                                        </div>
