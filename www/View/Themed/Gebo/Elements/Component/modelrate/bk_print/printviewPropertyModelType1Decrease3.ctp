...
<tr class="row_body">
	...
	<td class="center"><b>'.$sumTotal[3].'</b></td>
...
foreach($sumRankCorp as $key_rank=> $sumCorp){
	...
	<tr class="row_body">
		...
		<td class="center"><b>'.$sum_mos[3].'</b></td>
...
$body .= '
		<tr class="row_body">
			...
			<td class="center"><b>'.$sum_mos_total[3].'</b></td>
...
<table>
	<tbody>
		<tr class="row_body">
			...
			<td width=40px class="center"><b>'.$sumRankGroup[0][3].'</b></td>
...
<tr class="row_body">
	...
	<td class="center"><b>'.$sumRankGroup[1][3].'</b></td>
...
<tr class="row_body">
	...
	<td class="center"><b>'.$sumRankGroup[2][3].'</b></td>
