<?php 
        ...
        $default['organization_id'] = empty($default['organization_id']) ? '' : $default['organization_id']; 
		 $default['org_code'] = empty($default['org_code']) ? '' : $default['org_code']; 
?>
		...
		<div class="box box-color box-bordered">
			...
			<div class="box-content nopadding">
					...
					<div class="row-fluid">
                                                            ...
                                                            <?php
                                                                echo $this->Form->input('org_code', array(
                                                                    'label' => 'เลขประจำส่วนราชการ :',
                                                                    'div' => true,
                                                                    'class' => 'span6',
                                                                    'placeholder' => 'ชื่อย่อหน่วยผู้ใช้',
                                                                    'default' => $default['org_code']
...
<script>
		function modalAction2(){
			...
			var org_code = $("input[name='data[org_code]']").val();
