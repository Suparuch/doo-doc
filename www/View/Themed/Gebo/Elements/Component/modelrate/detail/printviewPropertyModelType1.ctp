...
body, input, textarea { font-family:TH SarabunPSK; font-size:13px !important ; }
...
<table>
	<thead>
		<tr class="border_top_header">
			...
			<th rowspan="2" width=50px class="left">ชั้นยศ</th>
			<th rowspan="2" width=45px>เหล่า</th>
			<th rowspan="2" width=40px class="right">ชกท.'.$space_5.'</th>
...
if(!empty($model_comment)){
	...
	<table>
		<tbody>
			...
			<tr>
			<td></td>
			<td>'.substr(nl2br($model_comment),0,6500).'</td>
			</tr>
