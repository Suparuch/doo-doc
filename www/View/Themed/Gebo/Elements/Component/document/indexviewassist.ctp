		...
		<div class="box box-bordered box-color">
			...
			<div class="row-fluid">
				...
				<div class="span8">
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form action="../../Document/index2/?act=assist" id='form_search' method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
			...
			<div class="box-content nopadding">
				...
				<table class="table table-bordered">
					<thead>
						<tr><th style="text-align: center;width:50px;"><input type="checkbox" class="toggle"></th>
                            ...
                            <th style="text-align: center;width:150px;">เลขที่หนังสือ	t</th>
...
?>
	...
	if($doc['status']=="4"){
	?>
    								<a class="link-bb" href="#" onclick='recievedoc("<?php echo $doc['id'];?>","5")'>ทราบ</a> 
    <?php
	}else{
		echo "ทราบแล้ว";
	}
