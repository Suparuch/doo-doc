...
class EmployeeOrganizationsController extends AppController {

	public $name = 'EmployeeOrganizations';
	public $uses = array('EmployeeOrganization');
	...
	public function index() {
		...
		if(empty($dataRequest)){
			...
			if(!empty($name)) $whereConditions[] = 'organization_code ILIKE \'%'.$name.'%\' or organization_name ILIKE \'%'.$name.'%\'';
		...
		$breadcrumb = array (   'controller' => array(   
								'name' => 'ข้อมูล หน่วยบรรจุอัตราพนักงานราชการ' ,
								'url' => ''
								)
		);
