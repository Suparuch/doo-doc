...
<div class='controls'>
<input type='radio' id='c_r' name='book_type' value='1' onclick='hide_send()'>
<label for='c_r' style='display:inline-block'>&nbsp;&nbsp;หนังสือรับ</label>&nbsp;&nbsp;&nbsp;&nbsp;
<input type='radio' id='c_o' name='book_type' value='2' checked='checked' onclick='show_send()'><label for='c_o' style='display:inline-block'>&nbsp;&nbsp;หนังสือส่ง</label>
</div>
</div>
</div>
...
<div class="control-group">
											<div class="">
												...
												<div class="controls">
				<input type="textbox" name="from" value='ยก.ทบ.' id='from' value='<?php echo $default['from'];?>' placeholder=""  style=";" class=''
...
<a href="#myModal2" data-toggle="modal" data-backdrop="static" class="link-bb display" data-tableid="smpl_tbl" style='visibility: hidden' onclick="showunit()">หน่วย</a>
 ...
 <div class="control-group">
											<div class="">
												...
												<div class="controls">
													<input type="textbox" name="to" id='to' placeholder="หน่วยงาน"  value='<?php echo $default['to'];?>' style=";" class=''
 ...
 ?> >
                                        ...
                                        <div class="control-group">
											<div class="">
												...
												<div class="controls">
													<input type="textbox" name="unit" id='unit'  value='<?php echo $default['worker'];?>' placeholder="หน่วยงาน"  style=";" class=''
...
var category_id = $("select[name='data[document_group]']").val();
		...
		function modalAction2(){
			...
			var keyword = $("input[name='data[keyword]']").val();
				...
				if(code != "")
				  {         
					var url = "../../Document/save/"+corp_id +"<?php 
					if(!empty($id))
						echo "/" . $id;
					 ?>";
	  ...
	  success: function(response) {
            ...
            // return response; // <- tried that one as well
			  $(".close").trigger( "click" );					
            window.location="../../Document/index2/?act=staffdoc&secrete=N"; 
        }
    } );
						/*
							$.post(url,{
