...
<script type="text/javascript">
    ...
    "title":'อจย.',
            ...
            var nodeId = node.attr('id');
                    if (node != - 1){
            return "/ModelRates/getTreeData/" + nodeId + '/' + organization_type;
            }
            else{
            return "/ModelRates/getTreeData/";
            }
            },
                    type: "POST",
...
//
            ...
            .bind(
                    ...
                    id = data.rslt.obj.attr("id");
                         ...
                         $('#organizationDetail' + organization_type).load("../../ModelRates/editModelRateTree/" + id, function(data) {
       // http://dopns.pakgon.com/ModelRates/editModelRate/150302150551598576            
        $('#organizationDetail' + organization_type).html(data);
                    });
                    }
            )
...
//
    ...
    function editData(id){
        ...
        $('#customModal2').html('');
            $('#customModalHeader2').html('แก้ไขข้อมูล #' + id);
            $('#customModalAction2').html('บันทึก');
