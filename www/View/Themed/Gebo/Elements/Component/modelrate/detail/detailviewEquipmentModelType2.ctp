<table class="table table-condensed table-bordered">
	<thead>
		<tr>
			...
			<th rowspan='2' width=240><center>หมายเหตุ</center></th>
		</tr>
		<tr>
	...
	<?php
		   ...
		   $rate_decrease_3 = 0;
		   $rate_structure = 0;
		   $ModelDivisions = $ModelDivisionSpecialEquipments;
		   ...
		   if(!empty($ModelDivisions)) { 
			...
			<tr>
				...
				<td><?php echo $ModelDivision['ModelDivisionSpecialEquipment']['name'];?></td>
				<td></td>
				<td></td>
				<td></td>
				<td><?php echo $ModelDivision['ModelDivisionSpecialEquipment']['comment'];?></td>
			</tr>
					<?php
