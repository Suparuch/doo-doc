<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered">
			...
			<!--<h3 class="heading"><?php echo __('รายละเอียด  ข้อมูลอัตรามูลฐานกระสุนและวัตถุระเบิด') ;?></h3>-->
				...
				<?php //echo $this->Form->create('Accounts', array('action' => 'saveAccount','class' => 'form-horizontal form-bordered'));?>
					<div class="row-fluid">
						...
						<table class="table table-bordered">
						    <thead>
							<tr>
							    <th colspan=12><center>รายละเอียด  ข้อมูลอัตรามูลฐานกระสุนและวัตถุระเบิด</center></th>
							</tr>
						    </thead>
						    <tbody>
							<tr>
							...
							<tr>
							    <td>ชื่ออัตรามูลฐานกระสุนและวัตถุระเบิด </td>
							    <td>ไม้พายเรือยาง</td>
							</tr>
							<tr>
							    <td>รูปอัตรามูลฐานกระสุนและวัตถุระเบิด </td> 
							    <td>
