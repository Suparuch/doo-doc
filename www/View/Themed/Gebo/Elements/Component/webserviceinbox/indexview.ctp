...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-bordered box-color">
			<div class="box-title">
				<h3 class="heading">
					ระบบเชื่อมต่อข้อมูลระหว่างสายงาน (ขาเข้า)
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
							 <li class='hideme mm_13_add'><a href="#myModal2" onclick="generate_webservice();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i> สร้างข้อมูลส่งให้สายงานอื่นๆ </a></li>
                                                ...
                                                <li class='hideme mm_13_add'><a href="/data_transfer.xls" onclick="addDocumentGroup();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-document_copy"></i> รายงานการได้รับข้อมูล </a></li>
					...
					if ($handle = opendir($path)) {
						...
						while (false !== ($entry = readdir($handle))) {
							...
							?>
								...
								<td><a href='/download.php?file_name=<?php echo $file_name;?>&path=input'>Download</a> | <a href='/WebServiceInbox/Detail/?file_name=<?php echo $file_name;?>'>View Detail</a></td>
