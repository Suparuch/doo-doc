			...
			<div class="row-fluid">
					...
					<div class="dt_actions">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
                                                <li class=' hideme mm_22_add'><a href="#myModal2" onclick="addProvince();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่ม </a></li>
								<li class=' hideme mm_22_delete'><a href="#"  class="delete" data-tableid="smpl_tbl"><i class="icon-trash"></i> ลบ </a></li>
				...
				<div class="span6">
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form  action="../../Provinces" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
								<input name="name" type="text" value="<?php echo $default['name']; ?>" placeholder="<?php echo __('ชื่อจังหวัด');?>" onkeypress="keyTextThai()">
								<button id="Unit-submit" type="submit" class="btn btn-primary  hideme mm_22_list">ค้นหา</button>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center;">
							<a data-toggle="modal" data-backdrop="static" href="#myModal2" onclick="editProvince('<?php echo $province['Province']['id']; ?>');" class=' hideme mm_22_edit' ><i class="icon-pencil"></i></a>
							<a href="#" class="delete  hideme mm_22_delete" value="<?php echo (string)$province['Province']['id']; ?>"><i class="icon-trash"></i></a>
							</td>
