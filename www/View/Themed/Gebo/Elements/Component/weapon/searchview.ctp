						...
						<div class="span12">
							<div class="box box-color box-bordered">
								<div class="box-title">
									...
									<?php echo __('ค้นหา') . ' ' . __('ข้อมูลอัตรามูลฐานกระสุนและวัตถุระเบิด') ;?>
									</h3>
								</div>
                                                                
								<div class="box-content nopadding">
									<form  action="../../Weapons" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
										...
										<!--<button type="submit" class="btn btn-primary"><?php //echo __('Search');?></button>-->
											...
											<button id="<?php echo $pagination['model']; ?>-submit" type="submit" class="btn btn-primary add_rows_simple hideme mm_4_list"><?php echo __('ค้นหา');?></button>
