					...
					<div class="dt_actions">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li class=' hideme mm_27_add'><a href="#myModal2" onclick="addWeaponBullet();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่ม </a></li>
								<li class=' hideme mm_27_delete'><a href="#"  class="delete" data-tableid="smpl_tbl"><i class="icon-trash"></i> ลบ </a></li>
					...
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form  action="../../WeaponBullets" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
								<input name="name" type="text" value="<?php echo $default['name']; ?>" placeholder="<?php echo __('ชนิดอาวุธ');?>" onkeypress="keyTextThai()">
								<?php
								...
								?> 
								<button id="Unit-submit" type="submit" class="btn btn-primary  hideme mm_27_list" >ค้นหา</button>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<?php foreach($WeaponBullets as $WeaponBullet) { ?>
							...
							<td style="text-align: center;">
								<a class=' hideme mm_27_detail' data-toggle="modal" data-backdrop="static" href="#myModal2" onclick="detailWeaponBullet('<?php echo $WeaponBullet['WeaponBullet']['id']; ?>');" ><i class="splashy-zoom_in"></i></a>
								<a class=' hideme mm_27_edit'' data-toggle="modal" data-backdrop="static" href="#myModal2" onclick="editWeaponBullet('<?php echo $WeaponBullet['WeaponBullet']['id']; ?>');" ><i class="icon-pencil"></i></a>
								<a href="#" class="delete  hideme mm_27_delete" value="<?php echo (string)$WeaponBullet['WeaponBullet']['id']; ?>"><i class="icon-trash"></i></a>
							</td>
						</tr>
						<?php } ?>
						<?php }else{ ?>
