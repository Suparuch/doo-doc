					...
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form  action="../../EDocument/index/<?php echo $corp_id;?>" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
								ค้นหา
								<input name="code" style='width:80px;' value='<?php echo $default['code'];?>' type="text" placeholder="<?php echo __('เลขที่หนังสือ');?>" >
								
								<input name="date"  style='width:80px;' value='<?php echo $default['book_date'];?>'  type="text" placeholder="<?php echo __('ลงวันที่');?>" >
								
								<input name="name_th"  style='width:200px;' value='<?php echo $default['name_th'];?>' type="text" placeholder="<?php echo __('เรื่องหนังสือ');?>" >
								<select name='fast' style='width:100px;' id='fast'>
								...
								<button id="Document-submit" type="submit" class="btn btn-primary hideme mm_13_list">ค้นหา</button>
				...
				<table class="table table-bordered tablesorter">
					<thead>
						<tr>
							...
							<th class='header ' style="text-align: center;width:70px;">เลขที่หนังสือ รับ - ส่ง</th>
							<th class='header ' style="text-align: center;width:70px;">ลงวันที่</th>
                                                        <th class='header ' style="text-align: center;">เรื่องหนังสือ</th>
 <th class='header ' style="text-align: center;">หมวดหมู่</th>
							<th class='header ' style="text-align: center;width:200px;">ไฟล์เอกสาร</th>
							<th class='header ' style="text-align: center;width:70px;">ชั้นความเร่งด่วน</th>
							<th class='header ' style="text-align: center;width:70px;">ชั้นความลับ</th>
							<th class='header ' style="text-align: center;width:70px;">ดาวน์โหลด/ลบ</th>
						</tr>
					</thead>
					<tbody>
...
<td>
<?php 
if(!empty($DocumentGroup[$doc['Document']['document_group']]))
echo $DocumentGroup[$doc['Document']['document_group']]; ?>
</td>
							<td>
                                                          <?php if(!empty($doc['Document']['file_name'])) 
														  {
                                                                echo "<a href='/EDocument/download_file/" . $doc['Document']['id'] . "' target='_blank'/>" . $doc['Document']['file_name'] .  "</a>";
