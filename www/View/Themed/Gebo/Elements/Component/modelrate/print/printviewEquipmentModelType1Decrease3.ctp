...
/*body, input, textarea { font-family:TH SarabunPSK; font-size:11px; }*/
...
<table>
	<tbody>
		...
		<tr class="row_body">
			<td></td>
			<td></td>
			<td class="left" colspan="10"><b>รายการจ่ายแจกยุทโธปกรณ์</b></td>
		</tr>
';
	...
	foreach($divisions as $division){
		...
		foreach($equipments as $equipment){
			...
			<tr class="row_body">
				...
				<td class="center">'.$equipment['rate_decrease_3'].'</td>
...
foreach($Techs as $key_tech => $Tech){
	...
	<tr class="row_body">
		...
		<td></td>
		<td colspan="10"><b>'.$Techs[$key_tech].'</b></td>
	</tr>
	';
	...
	foreach($sumEquipment as $key_equipment=> $equipment){
		...
		<tr class="row_body">
			...
			<td class="center">'.number_format($equipment[0],0,".",",").'</td>
			<td class="center">'.number_format($equipment[1],0,".",",").'</td>
			<td class="center">'.number_format($equipment[2],0,".",",").'</td>
			<td class="center">'.number_format($equipment[3],0,".",",").'</td>
			<td class="center">'.number_format($equipment[4],0,".",",").'</td>
			<td></td>
			<td></td>
		</tr>
		';
	...
	if(!empty($sumEquipment)){
		...
		<tr class="row_body">
			...
			<td class="center"><b>'.number_format($sum_equipment[1],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment[2],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment[3],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment[4],0,".",",").'</b></td>
			<td></td>
			<td></td>
		</tr>
		';
		...
		<tr class="row_body">
			...
			<td>01</td>
			<td></td>
			<td colspan=9>(ไม่กำหนดรายการยุทโธปกรณ์)</td>
		</tr>
		';	
	}
...
$body .= '
		<tr class="row_body">
			...
			<td class="center"><b>'.number_format($sum_equipment_total[1],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment_total[2],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment_total[3],0,".",",").'</b></td>
			<td class="center"><b>'.number_format($sum_equipment_total[4],0,".",",").'</b></td>
			<td></td>
			<td></td>
		</tr>
	</tbody>
