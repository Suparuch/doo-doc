			...
			<div class="row-fluid">
				...
				<div class="span8">
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form action="../../EDocument/index2/150120132326915176" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                            
                            ค้นหา&nbsp;
                            <input name="" value="" type="text" placeholder="ส่วนราชการ" style="width:100px;">
                            <input name="" value="" type="text" placeholder="เลขที่หนงสือ" style="width:100px;">
                            <input name="" value="" type="text" placeholder="ลงวันที่" style="width:100px;">
                            <input name="" value="" type="text" placeholder="เรื่องหนังสือ" style="width:150px;">
                            <select style="width:100px;">
                            <option>ความเร่วด่วน</option>
                            </select>
                            <select style="width:100px;">
                            <option>ชั้นความลับ</option>
                            </select>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
                            ...
                            <th style="text-align: center;width:200px;">ชั้นความลับ</th>
                            <th style="text-align: center;width:200px;">ชั้นความเร่งด่วน</th>
                            <th style="text-align: center;width:150px;">รหัส</th>
							<th style="text-align: center;width:150px;">ชื่อเรื่อง</th>
                                                        <th style="text-align: center;width:250px;">การกระทำ</th>
...
<td><?php echo $doc['code'];?>
							...
							<td style="text-align: center;">
                            <?php
if(isset($_REQUEST['act']) && $_REQUEST['act']=='receive'){
	?>
								<a class="link-bb" href="/Document/index2/?act=receive">ทราบ</a>  <a href="#myModal2" onclick="assignDocument();" data-toggle="modal" data-backdrop="static" class="link-bb display" data-tableid="smpl_tbl">มอบหมาย</a>
                                <?php 
}else if(isset($_REQUEST['act']) && $_REQUEST['act']=='director'){
								?>
                                <a class="link-bb" href="/Document/index2/?act=receive">ทราบ</a>  <a href="#myModal2" onclick="assignDocument();" data-toggle="modal" data-backdrop="static" class="link-bb display" data-tableid="smpl_tbl">เปิด</a>
                                <?php
}else{
	?>
    								<a class="link-bb" href="#" onclick='recievedoc("<?php echo $doc['id'];?>","2")'>รับ</a> 
    <?php
}
?>
							</td>
							...
							foreach($docs as $d){
								...
								if($doc['file_name']=="")
									continue;
								$i++;
							 echo "$i . <a href='/Document/download_file/" . $doc['id'] . "' target='_blank'/>" . $doc['file_name'] .  "</a><br />";
							}
							?>
                            </td>
						</tr>
