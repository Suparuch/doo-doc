/* [ ---- Gebo Admin Panel - mailbox ---- ] */
    ...
    $(document).ready(function() {
		...
		$('#button-add').click(function(){
			...
			//var tr = $('<tr><td>3</td><td>รามอินทราทีมA</td></tr>');
			var tr = $('<tr><td class="table-checkbox hidden-480"><input class="selectable" type="checkbox"></td><td class="table-icon hidden-480"><a class="sel-star active" href="#"><i class="icon-star"></i></a></td><td class="table-fixed-medium"> Add Johny Doesy </td><td> Add Lorem ipsum sint laborum. </td><td class="table-icon hidden-480"> Add Lorem ipsum sint laborum. </td><td class="table-date hidden-480"> 12. Feb </td></tr>');
