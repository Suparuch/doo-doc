<div class="row-fluid">
	<div class="span12">
		<div class="box box-bordered box-color">
			<div class="box-title">
				<h3 class="heading">
					รายงาน อัตราการจัด ตามหน่วยงาน
				</h3>
			</div>
			...
			<div class="btn-group sepH_b">
				...
				<ul class="dropdown-menu">
					<li><a href="#myModal2" onclick="addModelRate();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เปรียบเทียบ </a></li>
				</ul>
			</div>
...
<script type="text/javascript">
            ...
            function addModelRate(){
				  ...
				  $('#customModal2').load("../../ModelRates/detailModelRate",function(data) {
