...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-bordered box-color">
			<div class="box-title">
				<h3 class="heading">
					ขั้นตอนการรับหนังสือเข้าโดยผู้อำนวยการกอง
			...
			<div class="row-fluid">
				...
				<div class="span8">
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form action="../../Document/index2/?act=director" id='form_search' method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                            ...
                            <option value="S">มอบหมายแล้ว</option>
                            </select>
...
if(isset($_REQUEST['act']) && $_REQUEST['act']=='director'){
    ...
    <?php
		...
		if($doc['status']!="4" && ceil($doc['status'])<1000)
			echo "ทราบแล้ว";
		else
		{
			$assign_to = "";
	...
	if($doc['status']!="4" && isset($_GET['type']) && $_GET['type']==2){
	?>
                                
                                 <a href="#" onclick="recievedoc('<?php echo $doc['id'];?>');" data-toggle="modal" data-backdrop="static" class="link-bb display" data-tableid="smpl_tbl">อนุมัติ</a>
                                 <a class="link-bb" href="#" onclick='recievedoc("<?php echo $doc['id'];?>","1")'>ยกเลิก</a> 
                                <?php
	}
}else{
	if($doc['status']=="0"){
