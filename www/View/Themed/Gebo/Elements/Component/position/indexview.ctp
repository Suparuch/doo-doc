					...
					<div class="dt_actions">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li class=' hideme mm_21_add'><a href="#myModal2" onclick="addPosition();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่ม </a></li>
								<li class=' hideme mm_21_delete'><a href="#"  class="delete" data-tableid="smpl_tbl"><i class="icon-trash"></i> ลบ </a></li>
					...
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form  action="../../Positions" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
								...
								<button id="Unit-submit" type="submit" class="btn btn-primary">ค้นหา</button>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>									
							...
							<td style="text-align: center;">
							<a data-toggle="modal" data-backdrop="static" href="#myModal2" onclick="editPosition('<?php echo $Position['Position']['id']; ?>');"  class=' hideme mm_21_edit'><i class="icon-pencil"></i></a>
							<a href="#" class="delete  hideme mm_21_delete" value="<?php echo (string)$Position['Position']['id']; ?>"><i class="icon-trash"></i></a>
							</td>
						</tr>
							<?php } ?>
							<?php }else{ ?>
