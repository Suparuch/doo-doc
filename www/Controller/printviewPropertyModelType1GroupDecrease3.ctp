...
<table>
	<thead>
		<tr class="border_top_header">
			...
			<th rowspan="2" width=40px class="left">ชั้นยศ</th>
		...
		<tr class="row_head_body">
			...
			<th width=40px>ลด 3</th>
			<th width=40px>โครง</th>
		</tr>
...
foreach($ModelGroups as $modelGroup){
	...
	<tr>
		...
		<td >&nbsp;</td>
		<td class="left" colspan="11">'.$modelGroup['model']['name'].'(อจย. '.$modelGroup['model']['code'].')'.'</td>
	</tr> 
	';
