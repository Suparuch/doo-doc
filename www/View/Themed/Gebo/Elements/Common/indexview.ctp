					...
					<div class="dt_actions">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
                                                <li class='hideme mm_13_add'><a href="#myModal2" onclick="addDocumentGroup();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่มหมวดหมู่เอกสาร </a></li>
								 <li class='hideme mm_13_add'><a href="#myModal2" onclick="addDocument();" data-toggle="modal" data-backdrop="static" class="add_rows_simple" data-tableid="smpl_tbl"><i class="splashy-add"></i></i> เพิ่มเอกสาร </a></li>				
					...
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form  action="../../Ranks" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
								<input name="name" type="text" value="<?php echo $default['name']; ?>" placeholder="<?php echo __('ค้นหา (เลขที่หนังสือ, ลงวันที่, เรื่อง, สถานะ)');?>" onkeypress="keyTextThai()">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th style="text-align: center;">รหัสเอกสาร</th>
                                                        <th style="text-align: center;">ชื่อเอกสาร</th>
							<th style="text-align: center;">ไฟล์เอกสาร</th>
...
<script type="text/javascript">
		 ...
		 $('#customModal2').html('');
				  $('#customModalHeader2').html('สร้างหมวดหมู่เอกสาร');
		 ...
		 $('#customModal2').html('');
				  ...
				  $('#customModalAction2').html('บันทึก');
				  $('#customModal2').load("../../EDocument/form",function(data) {
						$('#customModal2').html(data);
				  });
