...
<table> 
	<tr valign="bottom">
		<td height="25px" style="vertical-align:bottom" width="45%">
			<b>ตอนที่ 3 อัตรากำลังพล </b>
		</td>
		<td style="vertical-align:bottom"><center>
			<b>กองทัพบกไทย</b>
			</center>
		</td>
		<td style="vertical-align:bottom" width="45%" align="right"><b>'.$model_name . '</b></td>
	</tr>
</table>
...
<table>
	<thead>
		<tr class="border_top_header">
			...
			<th rowspan="2" width=55px class="left">ชั้นยศ</th>
			<th rowspan="2" width=50px>เหล่า</th>
			<th rowspan="2" width=55px class="right">ชกท.'.$space_5.'</th>
			<th colspan="4">อัตราระดับความพร้อมรบ</th>
			<th rowspan="2" width=40px>อาวุธ</th>
			<th rowspan="2" width=60px>หมายเหตุ</th>
		</tr>
...
if(isset($_GET['debug']) && $_GET['debug']==1){
	print_r($division);
		...
		if(count($positions) <=0)
			continue;
		$key_division = $division['order_sort'];
		$body .= '
		
		<tr class="row_body">
			<td class="center"><b>'.str_pad($key_division, 2, '0', STR_PAD_LEFT).'</b></td>
			<td></td>
			<td class="left" colspan="10"><b>'.$division['name'].  ' </b></td>
		</tr> 
		';
		...
		foreach($positions as $position){
			...
			foreach($properties as $property){
				...
				}else if($property['rank_id']>=12 && $property['rank_id']<20 && $property['rank_id']!=19 )    {
		...
		<tr class="row_body">
			<td></td>
			<td></td>
			<td colspan="2" align="right">' . $division['name'] . '</td>
			<td></td>
			<td ><b>รวม</b></td>
...
$body.= '<br /><br /><b><u>หมายเหตุ</u></b><div style="line-height:20px;width:680px">' . str_replace("\t",$space_5, nl2br(str_replace(" ","&nbsp;", $model_comment))) . '</div>' ;
/*
	$body .= '
	<br>
	...
	<table style="line-height:16px">
		<tbody>
			<tr class="row_body">
			<td class="center" width=40px>&nbsp;</td>
			<td><b><u>หมายเหตุ</u></b></td>
			</tr>
			<tr>
			<td></td>
			<td><div>';
			if(strlen($model_comment)>5500)
			{
				$body .= substr(nl2br($model_comment),0,5500);
				$body .= '</div></td></tr></tbody></table><table  style="line-height:16px"><tbody><tr class="row_body"><td width=40px></td><td><div>';
				$body .= substr(nl2br($model_comment),5500,10000);
				if(strlen($model_comment)>10000)
{
				$body .= '</div></td></tr></tbody></table><table  style="line-height:16px"><tbody><tr class="row_body"><td width=40px></td><td><div>';
				$body .= substr(nl2br($model_comment),10000,15000);
}
	if(strlen($model_comment)>15000)
{
				$body .= '</div></td></tr></tbody></table><table  style="line-height:16px"><tbody><tr class="row_body"><td width=40px></td><td><div>';
				$body .= substr(nl2br($model_comment),10000,15000);
}
...
foreach($sumRankCorp as $key_rank=> $sumCorp){
	...
	foreach($sumCorp as $key_corp=> $sumMos){
		...
		foreach($sumMos as $key_mos=> $mos){
			...
			<tr class="row_body">
				...
				<td class="center">'.$mos[1].'</td>
				<td class="center">'.$mos[2].'</td>
				<td class="center">'.$mos[4].'</td>
				<td></td>
				<td></td>
			</tr>
			';
	...
	<tr class="row_body">
		...
		<td></td>
		<td></td>
		<td colspane="2"><b>รวม</b></td>
		<td class="center"><b>'.$sum_mos[0].'</b></td>
		<td class="center"><b>'.$sum_mos[1].'</b></td>
		<td class="center"><b>'.$sum_mos[2].'</b></td>
		<td class="center"><b>'.$sum_mos[4].'</b></td>
		<td></td>
		<td></td>
	</tr>
	';
...
$body .= '
		<tr class="row_body">
			...
			<td class="center"><b>'.$sum_mos_total[1].'</b></td>
			<td class="center"><b>'.$sum_mos_total[2].'</b></td>
			<td class="center"><b>'.$sum_mos_total[4].'</b></td>
			<td></td>
			<td></td>
		</tr>
	</tbody>
...
<table>
	<tbody>
		<tr class="row_body">
			...
			<td width=40px class="center"><b>'.$sumRankGroup[0][0].'</b></td>
			<td width=40px class="center"><b>'.$sumRankGroup[0][1].'</b></td>
			<td width=40px class="center"><b>'.$sumRankGroup[0][2].'</b></td>
			<td width=40px class="center"><b>'.$sumRankGroup[0][4].'</b></td>
			<td width=40px></td>
			<td width=100px></td>
		</tr>
';
...
<tr class="row_body">
	...
	<td class="center"><b>'.$sumRankGroup[1][1].'</b></td>
	<td class="center"><b>'.$sumRankGroup[1][2].'</b></td>
	<td class="center"><b>'.$sumRankGroup[1][4].'</b></td>
	<td></td>
	<td></td>
</tr>
';

if($sumRankGroup[3][0]=='' && $sumRankGroup[3][1]=='' && $sumRankGroup[3][2] =='' && $sumRankGroup[3][4]==''){
}else{
$body .= '
<tr class="row_body">
	<td></td>
...
<tr class="row_body">
	...
	<td class="center"><b>'.$sumRankGroup[2][1].'</b></td>
	<td class="center"><b>'.$sumRankGroup[2][2].'</b></td>
	<td class="center"><b>'.$sumRankGroup[2][4].'</b></td>
	<td></td>
	<td></td>
</tr>
';
