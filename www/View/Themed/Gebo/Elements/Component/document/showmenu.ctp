...
<button class='main_menu' onclick='goto(1)'>หนังสือกอง<br /><br />
ลงนามโดย ผู้อำนวยการกอง
<br /><br />
อนุมัติโดย ผู้อำนวยการกอง
</button>
</td><td>
<button class='main_menu' onclick='goto(2)'>หนังสือกอง <br /><br />
ลงนามโดย ผู้อำนวยการกอง <br /><br />
อนุมัติโดย เจ้ากรม</button>
</td>
</tr>
<tr><td>
<button class='main_menu' onclick='goto(3)'>หนังสือกรม <br /><br />
ลงนามโดย ผู้อำนวยการสำนัก / เจ้ากรม<br /><br />
อนุมัติโดย ผู้อำนวยการสำนัก / เจ้ากรม  </button>
</td>
<td>
<button class='main_menu' onclick='goto(4)'>หนังสือกรม <br /><br />
ลงนามโดย เจ้ากรม <br /><br />
อนุมัติโดย ผู้บังคับบัญชาของกองทัพบก
</button>
</td>
</tr>
</table>
