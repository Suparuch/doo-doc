<table class="table table-condensed table-bordered">
	...
	<?php if(!empty($ModelDivisions)) { ?>
			...
			<tr>
				...
				<td></td>
				<td><b>รวม</b></td>				
				<td><center><b><?php echo number_format($sum_rate_full,0,".",",");?></b><center></td>
				<td><center><b><?php echo number_format($rate_decrease_1,0,".",",");?></b><center></td>
				<td><center><b><?php echo number_format($rate_decrease_2,0,".",",");?></b><center></td>
				<td><center><b><?php echo number_format($rate_decrease_3,0,".",",");?></b><center></td>
				<td><center><b><?php echo number_format($rate_structure,0,".",",");?></b><center></td>
				<td></td>
			</tr>
