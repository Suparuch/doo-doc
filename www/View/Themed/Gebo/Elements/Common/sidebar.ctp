...
?>
<?php
if ($this->params->params['controller'] == 'Document' || $this->params->params['controller'] == 'Users'  || $this->params->params['controller'] == 'Units' || $this->params->params['controller'] == 'AclRoles'){
?>
<style type="text/css">
.main_content{
            ...
            <div class="antiscroll-content">
                ...
                <div class="sidebar_inner">
                    ...
                    <div id="side_accordion" class="accordion">
                        ...
                        <div class="accordion-group" id='150120132230205092'>
                            ...
                            <?php
                            if ($this->params->params['controller'] == 'ModelRates' ||
...
<!--<li><?php echo $this->Html->link(__('ระบบงานการจัดการ'), '/Folders/detail'); ?></li>-->
                                            <li class='hideme mm_30_access' ><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132230205092'); ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

                            <div class="accordion-group" id='150120132211772467'>
                                <div class="accordion-heading">
                                ...
                                <?php
                                if ($this->params->params['controller'] == 'Organizations' ||
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="accordion-inner">
                                            <ul class="nav nav-list">
                                                <li class='hideme mm_6_access' <?php if ($this->params->params['controller'] == 'Organizations' && $this->params->params['action'] == 'control') echo 'class="active"'; ?>><?php echo $this->Html->link(__('ระบบการปฎิบัติการทางด้านยุทธการ'), '/Organizations/control'); ?></li>
                                                ...
                                                <li class='hideme mm_31_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132211772467'); ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-group" id='150120132353162372'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap15">
                                        <div class="accordion-inner">
                                            ...
                                            <ul class="nav nav-list">
                                                <li class='hideme mm_28_access' <?php if ($this->params->params['controller'] == 'Capacity') echo 'class="active"'; ?>><?php echo $this->Html->link(__("รายงานความพร้อมรบ"), "/Capacity/index/1"); ?></li>
                                                <li class='hideme mm_28_access' <?php if ($this->params->params['controller'] == 'Capacity') echo 'class="active"'; ?>><?php echo $this->Html->link(__("รายงานความพร้อมรบ​(ยุทโธปกรณ์)"), "/ECapacity/index/1"); ?></li>
                                                <li class='hideme mm_28_access' <?php if ($this->params->params['controller'] == 'pdxHistory') echo 'class="active"'; ?>><?php echo $this->Html->link(__('ประวัติกำลังพล'), '/pdxHistory/index/1'); ?></li>
                                                <li class='hideme mm_28_access' <?php if ($this->params->params['controller'] == 'pdxReport') echo 'class="active"'; ?>><?php echo $this->Html->link(__('รายงานกำลังพล'), '/pdxReport/index/1'); ?></li>

                                                <li class='hideme mm_28_access' <?php if ($this->params->params['controller'] == 'ModelRates') echo 'class="active"'; ?>><?php echo $this->Html->link(__('ระบบงานอัตราการจัดและยุทโธปกรณ์'), '/ModelRates/index/1'); ?></li>

                                                <li class='hideme mm_29_access' <?php if ($this->params->params['controller'] == 'ModelRates') echo 'class="active"'; ?>><?php echo $this->Html->link(__('ระบบงานอัตราเฉพาะกิจ'), '/ModelRates/index/2'); ?></li>


                                                <li class='hideme mm_32_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132353162372'); ?></li>
                                ...
                                <!--- สายงานอื่น -->
                                <div class="accordion-group" id='150120132703909467'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap8">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_33_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132703909467'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>

                                <div class="accordion-group" id='150120132546861804'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap9">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_34_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132546861804'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-group" id='150120132620058871'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap10">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_35_access' ><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132620058871'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-group" id='150120132642699380'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap11">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_41_access'>
                                                    <?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132642699380'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-group" id='150120132304954421'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap12">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_36_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132304954421'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>                                                               
                                ...
                                <div class="accordion-group" id='150120132326915176'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap13">
                                        <div class="accordion-inner">
                                            <ul class="nav nav-list">
                                                <li class='hideme mm_43_access' <?php if ($this->params->params['controller'] == 'Memorandums') echo 'class="active"'; ?>><?php echo $this->Html->link(__('ระบบงานประวัติศาสตร์และพิพิธภัณฑ์ทหาร'), '/Memorandums/index/'); ?></li>
                                                <li class='mm_999_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132326915176'); ?></li>
                                            </ul>
                                            <!--<div class="span4">
                                                <li class='hideme mm_37_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132326915176'); ?></li>
                                            </div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-group" id='150120103629101691'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap14">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_38_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120103629101691'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>

                                <div class="accordion-group" id='150120132448732208'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap16">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_39_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132448732208'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-group" id='150120132512200625'>
                                    <div class="accordion-heading">
                                    ...
                                    <div class="accordion-body collapse" id="collap17">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_40_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150120132512200625'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>

 <div class="accordion-group" id='150306122747374035'>
                                    <div class="accordion-heading">
                                        <a href="#collap17" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle in">
                                            <i class="icon-folder-close"></i> ระบบงานธุรการ
                                        </a>
                                    </div>
                                    <div class="accordion-body collapse" id="collap17">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li class='hideme mm_40_access'><?php echo $this->Html->link(__('ระบบงานรับ - ส่ง'), '/EDocument/index/150306122747374035'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>

				<?php if ($this->params->params['controller'] == 'Document') { ?>
				<div class="accordion-group" id='mm_document' >
                                    <div class="accordion-heading">
                                        <a href="#collap170" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle in">
                                            <i class="icon-folder-close"></i> ระบบงานสารบรรณ
                                        </a>
                                    </div>
                                    <div class="accordion-body collapse" id="collap170">
                                        <div class="accordion-inner">
                                            <div class="span4">
                                                <li><?php echo $this->Html->link(__('ระบบงานหนังสือเข้า'), '/Document/index/'); ?></li>
<li><?php echo $this->Html->link(__('ระบบงานรับ'), '/Document/index2/'); ?></li>
						<li><?php echo $this->Html->link(__('ระบบงานสำหรับ ผอ.'), '/Document/index2/?act=receive'); ?></li>
                                            </div>								
                                        </div>
                                    </div>
                                </div>
<?php } ?>
                                ...
                                <div class="accordion-group">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="accordion-inner">
                                                <ul class="nav nav-list">
                                                    ...
                                                    <li class='hideme mm_0_access' <?php if ($this->params->params['controller'] == 'Reports' && $this->params->params['action'] == 'byScience') echo 'class="active"'; ?>><?php //echo $this->Html->link(__('อจย/อฉก ตาม สายวิทยาการ'), '/Reports/byScience');  ?></li>
                                                    <li class='hideme mm_0_access' ><?php //echo $this->Html->link(__('เปรียบเทียบ อจย/อฉก'), '/Reports/compareModel');  ?></li>
                                    ...
                                    <div class="accordion-group">
                                        ...
                                        <?php
                                        if ($this->params->params['controller'] == 'Users' ||
                                                $this->params->params['controller'] == 'AclRoles' ||
                                                $this->params->params['controller'] == 'Units' || $this->params->params['controller'] == 'AclRoles'
                                        ) {
                                            ?>
...
///echo "Controller=" . $this->params->params['controller'];
if ($AuthUser['RoleUser']['role_id'] != "1") {
    echo "$('.accordion-group').hide();\n";
}

if ($this->params->params['controller'] == 'Document'  || $this->params->params['controller'] == 'Users'  || $this->params->params['controller'] == 'Units' || $this->params->params['controller'] == 'AclRoles'){
 echo "$('.sidebar').hide();\n";
//echo "$('#mm_document').show();\n";
}
?>
                        $(".hideme").hide();
<?php
...
echo "$('#" . $AuthUser['User']['unit_id'] . "').show();\n";
if (isset($AuthUser['menulist']) && count($AuthUser['menulist']) > 0) {
    foreach ($AuthUser['menulist'] as $menu) {
        if ($menu['access'] == "1") {
            ...
            echo "$(\".mm_" . $menu['action_id'] . "_access\").parent().show();\n";
            echo "$(\".mm_" . $menu['action_id'] . "_access\").parent().parent().show();\n";
            echo "$(\".mm_" . $menu['action_id'] . "_access\").parent().parent().parent().show();\n";
            echo "$(\".mm_" . $menu['action_id'] . "_access\").parent().parent().parent().parent().show();\n";
        }
        if ($menu['add'] == "1")
