...
<td>
<button class='main_menu' onclick='javascript:;' disabled><br />รายการหนังสือเข้า <br /><br /></button>
</td>
<td>
			...
			<div class="row-fluid">
				...
				<div class="span8">
					<div class="dataTables_filter" id="dt_gal_filter">
						<label>
							<form action="../../Document/index2/?act=staff" id='form_search' method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
<a href="#myModal2" onclick="remark('<?php echo $doc['id'] ;?>','<?php echo $doc['description'];?>');" data-toggle="modal" data-backdrop="static" class="link-bb display" data-tableid="smpl_tbl">หมายเหตุ</a>
